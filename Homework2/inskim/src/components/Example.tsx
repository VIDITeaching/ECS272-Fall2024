...
export default function Example() {
  ...
  function initChart() {
    ...
    const yLabel = chartContainer
      ...
      .attr(
        "transform",
        `translate(${margin.left / 2}, ${size.height / 2}) rotate(-90)`
      )
      .append("text")
      .text("Value")
    ...
    const xLabel = chartContainer
      ...
      .attr(
        "transform",
        `translate(${(size.width - margin.left) / 2}, ${
    ...
    const title = chartContainer
      ...
      .attr(
        "transform",
        `translate(${size.width / 2}, ${size.height - margin.top + 15})`
      )
