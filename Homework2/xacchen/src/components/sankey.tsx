...
const SankeyDiagram = () => {
  ...
  useEffect(() => {
    ...
    svg.append('text')
      ...
      .text('Relationship between Gender, Employment Status and Risk Level');
    ...
    svg.append('g')
      ...
      .text(d => d.depth < 2 ? d.id : "Risk Level: " + d.id)
      .style('font-family', 'monospace')
  ...
  const processDataForSankey = (csvData) => {
    ...
    csvData.forEach((row) => {
      ...
      // Ensure all fields are present // && education
      if (gender  && employment && risk) {
